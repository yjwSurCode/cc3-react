...
class Web2Game {
  ...
  loadScene(sceneName, callback) {
    console.log(
      'aa-sceneName,初始化加载场景 callback',
      sceneName,
      callback,
      cc,
      cc.web2cocosSDK,
    ); //{changeGameByPageIndex: ƒ, loadScene: ƒ, loadGame: ƒ, unloadGame: ƒ, loadCustomImage: ƒ, …}
  ...
  emit(eventName, params) {
    console.log('内部事件', eventName, params);
    if (eventName === 'nova.teacher.color') {
